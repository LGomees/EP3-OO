...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Series.count') do
      post series_index_url, params: { series: { category: @series.category, creator: @series.creator, name: @series.name, year: @series.year } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { category: @series.category, creator: @series.creator, name: @series.name, year: @series.year } }
